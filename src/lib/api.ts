...
export const api = {
  ...
  reports: {
    generate: (culvertId: number, reportType: string, includeCharts: boolean = true, parameters?: Record<string, any>) =>
      request<ReportResult>('/reports/generate', {
        method: 'POST',
        body: JSON.stringify({ culvert_id: culvertId, report_type: reportType, include_charts: includeCharts, parameters }),
      }),
